...
(function () {
  ...
  if (!raw) {
    document.write('<scr' + 'ipt type="text/javascript" src="./resources/ol3/ol.js"></scr' + 'ipt>');
  } else {
    window.CLOSURE_NO_DEPS = true; // we've got our own deps file
    document.write('<scr' + 'ipt type="text/javascript" src="./resources/bootstrap/base.js"></scr' + 'ipt>');
    document.write('<scr' + 'ipt type="text/javascript" src="./resources/ol3/ol-deps.js"></scr' + 'ipt>');
    document.write('<scr' + 'ipt type="text/javascript" src="./resources/js/' + scriptId + '-require.js"></scr' + 'ipt>');
  }
  document.write('<scr' + 'ipt type="text/javascript" src="./resources/js/' + scriptId + '.js"></scr' + 'ipt>');
}());